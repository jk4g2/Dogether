					     ...
					     // 예측 2: 티칭 가능한 기계 분류 모델을 통한 입력 실행
					        const prediction = await model.predict(posenetOutput);
								    ...
								    // ##############
									 ...
									 if(prediction[0].probability.toFixed(2) >= 0.95){   // 올바른 자세
											$("#ViewTimer_wrong").text("");											
											$("#ViewTimer_right").text("올바른 자세입니다");
											$("#ViewTimer_wait").text("");	
										 }
									 else if(prediction[2].probability.toFixed(2) >= 0.95){   // 올바른 자세
											$("#ViewTimer_wrong").text("");											
											$("#ViewTimer_right").text("올바른 자세입니다");
											$("#ViewTimer_wait").text("");	
										 }
							        
									 else if(prediction[1].probability.toFixed(2) > 0.80) {    // 차렷자세
								            $("#ViewTimer_wrong").text("");												 
									 ...
									 else if (prediction[1].probability.toFixed(2) < 0.95){    // 잘못된 자세
											$("#ViewTimer_wrong").text("자세에 좀 더 집중해주세요");												 
											$("#ViewTimer_right").text("");
											$("#ViewTimer_wait").text("");	
					 					}
