									...
									<!-- Content -->
										...
										<div class="row">
											<div class="col-6 col-12-small">
												<h3>Detail</h3>
												<p>다이어트를 한다면 기본적으로 해야할 검사. 체내의 체지방, 근육량, 체수분, 사이즈들을 분석해주는 검사다. 근육이 많은 사람은 유산소 운동을 중점으로 다이어트를 해야하고 적은 사람은 무산소 운동과 병행해가면서 운동을 해야 다이어트 효율이 높아진다. 즉 인바디 검사는 다이어트 방식의 방향을 제시하는 검사라고 할 수 있겠다.
													또한 열심히 다이어트를 하고 있다면 한 달에 한 번 정도 검사하면 점점 발전을 확인할 수 있다.</p>
											</div>
											<div class="col-6 col-12-small">
												<h3>How to do Inbody</h3>
												<p>다이어트에 대한 관심과 인바디 기계의 보급으로, 매우 널리 퍼지고 있다. 헬스장에도 하나씩 비치되어 있어 일단 가입을 한다면 이것부터 검사하고 운동상담을 해주는게 보통이다. 5분 안에 모든 절차가 끝나니 시간이 많이 걸릴까 걱정할 필요 없다.
													2013년부터는 일부 동네 보건소에서도 공짜로 받을 수 있다. 물론 아닌 동네도 있고, 몇 달에 한번만 검사해주는 곳도 있으니 미리 전화로 물어보고 방문하도록 하자.</p>
											</div>
											<!-- Break -->
											<div class="col-4 col-12-medium">
												<h3>See the result</h3>
												<p>기본적으로 가장 위쪽에 위치한 체성분분석 표에서 체중, 골격근량, 체지방량의 순서라고 봤을 때 각 부분의 끝 부분을 선으로 이을 때 'I'자에 가까울 수록 표준형, 'C' 자에 가까울 수록 비만형, '역 C'자에 가까울 수록 강인형이라고 한다.</p>
											</div>
											<div class="col-4 col-12-medium">
												<h3>Matters that you should pay attention </h3>
												<p>많은 비만인구들이 체성분 분석 결과를 보고 자신이 비록 살은 쪘지만 근육은 많은 체형이라는 착각을 한다. 표준 수치보다는 비율을 중점적으로 보면서 현재의 상태를 파악할 필요가 있다.</p>
											</div>
											<div class="col-4 col-12-medium">
												<h3>Inbody</h3>
												<p>'InBody'라는 이름 기업의 체성분 분석 제품 브랜드인 '인바디'가 체성분 분석검사를 통칭하는 보통명사로 굳어진 것이라고 할 수 있다.기업명보다 브랜드가 훨씬 유명하게 되면서 기업명을 바꾸었다.</p>
											</div>
										</div>
